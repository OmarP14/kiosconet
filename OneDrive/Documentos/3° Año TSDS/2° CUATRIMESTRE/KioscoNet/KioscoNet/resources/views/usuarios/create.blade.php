            ...
            <div class="col-md-8">
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        {{-- DESCRIPCIÓN DEL ROL --}}
                        <div id="rolDescripcion" class="alert d-none">
            ...
            <div class="col-md-4">
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <i class="fas fa-user-circle fa-5x text-primary" id="preview_icon"></i>
                        </div>
                        
                        <h5 id="preview_nombre" class="text-primary">Nombre del Usuario</h5>
                        <p class="text-muted mb-0" id="preview_email">email@ejemplo.com</p>
                        <p class="text-muted mb-3" id="preview_usuario">@usuario</p>
                    ...
                    <div class="card-body">
                        <small>
                            ...
                            <ul class="mb-2">
                                ...
                                <li>Usuario único</li>
                                <li>Contraseña (mín. 6 caracteres)</li>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function actualizarPreview() {
        ...
        if (rol === 'administrador') {
            ...
            icon.className = 'fas fa-user-circle fa-5x text-secondary';
            badgeDiv.innerHTML = '<span class="badge bg-secondary">Sin rol asignado</span>';
        }
    }
